...
namespace NoesisLabs.OathMultiFactorAuthenticationProvider
{
	public class AuthenticationAdapterMetadata : IAuthenticationAdapterMetadata
	{
		...
		{
			get { return "OATH Authentication Adapter"; }
		}
		...
		public Dictionary<int, string> FriendlyNames
		{
			get
			{
				...
				_friendlyNames.Add(new CultureInfo("en-us").LCID, "OATH Authentication Adapter");
		...
		public Dictionary<int, string> Descriptions
		{
			get
			{
				...
				_descriptions.Add(new CultureInfo("en-us").LCID, "OATH Authentication Adapter");
